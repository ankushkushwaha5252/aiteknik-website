...
const advisoryBoard = [
  {
    ...
    img: './assets/images/sangeeta.jpeg'
  },
  {
          ...
          {advisoryBoard.map((m, idx) => (
            ...
            >
              <div className="w-40 h-40 mx-auto mb-8 rounded-[30px] overflow-hidden border-2 border-slate-100 group-hover:border-cyan-500 transition-colors bg-slate-50 shadow-inner">
                <img src={m.img} alt={m.name} className="w-full h-full object-cover transition-all duration-500 group-hover:grayscale-0 group-hover:opacity-100" />
              </div>
